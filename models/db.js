...
const botSettingsSchema = new mongoose.Schema(
  {
    ...
    botPostingEnabled: { type: Boolean, default: false },
...
const botUserSchema = new mongoose.Schema(
  {
    ...
    redBannedAt: { type: Date, default: null, index: true },
    softBanUntil: { type: Date, default: null, index: true },
    softBanStage: { type: Number, default: 0 },
    softBanLastAt: { type: Date, default: null },
    softBanLastDurationSec: { type: Number, default: null },
    softBanReason: { type: String, default: null },
    ...
    onboardingStartedAt: { type: Date, default: null, index: true },
    onboardingMode: { type: String, enum: ['initial', 'partial_fix'], default: null },
    onboardingWarnedAt: { type: Date, default: null },
    onboardingFinalWarnedAt: { type: Date, default: null },
